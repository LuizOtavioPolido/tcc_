...
def preProcessamentoRoiPlaca():
    ...
    resize_img_roi = cv2.resize(
        img_roi, None, fx=4, fy=4, interpolation=cv2.INTER_CUBIC)
    ...
    cv2.imwrite("roi-ocr.png", img_desfoque)
